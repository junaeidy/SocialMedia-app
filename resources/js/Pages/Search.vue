<script setup>
import GroupItems from './user/app/GroupItems.vue';
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div class="shadow bg-white p-3 rounded mb-3">
                    ...
                    <div class="grid-cols-2">
                        <UserListItems v-if="users.length" v-for="user of users" :user="user"/>
                ...
                <div class="shadow bg-white p-3 rounded mb-3">
                    ...
                    <div class="grid-cols-2">
                        <GroupItems v-if="groups.length" v-for="group of groups" :group="group"/>
                        <div v-else class="py-8 text-center text-gray-500">
