        ...
        <div class="mb-3">
            <Disclosure v-slot="{ open }">
                ...
                <template v-if="post.body.length > 200">
                    <!-- <div v-if="post.body && !open" class="ck-content-output" v-html="post.body.substring(0, 200)"/>
                <template v-if="post.body && post.body.length > 200"></template> -->
                    <DisclosurePanel>
        ...
        <div class="grid gap-3 mb-3" :class="[
            ...
            <template v-for="(attachment,ind ) of post.attachments.slice(0,4)">
                ...
                <div class="group aspect-square bg-blue-100 flex flex-col items-center justify-center text-gray-500 relative">
                    ...
                    <div v-if="ind === 3" class="absolute left-0 top-0 right-0 bottom-0 z-10 bg-black/60 text-white flex items-center justify-center text-2xl"> +{{ post.attachments.length - 4 }} more </div>
                    <!-- Download-->
